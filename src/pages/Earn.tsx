...
export default function Earn() {
  ...
  >
      <div className="flex flex-col flex-1 w-full h-full px-6  pb-24 mt-12 " style={{color : "black"}}>
        {/* <img
          src="/images/coin.png"
          alt="coins-3"
 ...
 <h1 className="mt-4 text-2xl font-bold text-center uppercase">
      ...
      alignItems="center"
      margin={5}
      width="100" // Optionally center vertically as well
    >
      <TonConnectButton />
    </Box>
        ...
        {videoTasks.length > 0 && (
          <>
            <p className="mt-2.5 font-medium text-center">Mininion Community On YouTube</p>
            <div className="mt-4 space-y-2 ">
              {videoTasks.map((item) => (
                <ListItem
                  ...
                  action={
                    item.is_rewarded ? (
                      <CheckIcon className="w-6 h-6 text-[#ffff]"  />
                    ) : undefined
                  }
