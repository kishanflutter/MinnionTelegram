...
export default function Missions() {
 ...
 const [selectedMission] = useState<Mission | null>(null);
        ...
        <div className="mt-10" style={{color : "black"}}>
          ...
          <div className="mt-6">
            <div className="grid grid-cols-2 gap-3">
              {missions.isLoading ? (
                <div className="flex items-center justify-center h-full col-span-2 mt-6" style={{color : "black"}}>
                  ...
                  >
                    <div className="flex items-start flex-1 space-x-3" style={{color : "black"}}>
                      <img
                       ...
                       src="/images/coin.png"
                        alt={mission.name}
                        className="object-contain w-16 h-16" style={{color : "black"}}
                      />
                        ...
                        <div className="flex items-center space-x-3">
                          ...
                          mission.required_user_level > user.level!.level ? (
                            ...
                            mission.next_level?.cost && (
                              ...
                              //   className="text-[10px]" style={{color : "black"}}
                              // />
                              <p className="mt-1 text-[10px] font-medium">
                              0
                             </p>
